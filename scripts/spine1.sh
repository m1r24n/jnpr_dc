...
virt-install --name ${VM} \
	...
	--network bridge=s1l3 \
	--network bridge=s1l4 \
	--xml './devices/interface[1]/target/@dev=s1fxp0' \
	--xml './devices/interface[2]/target/@dev=s1p0' \
	--xml './devices/interface[2]/mtu/@size=9500' \
	--xml './devices/interface[3]/target/@dev=s1p1' \
	--xml './devices/interface[3]/mtu/@size=9500' \
	--xml './devices/interface[4]/target/@dev=s1p2' \
	--xml './devices/interface[4]/mtu/@size=9500' \
	--xml './devices/interface[5]/target/@dev=s1p3' \
